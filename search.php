...
<div class="container home-page">
    <?php
		...
		if($item_count==0){
    		...
    		?>
    		<div class="buy-tol">
    		    <b><center>Total <?php echo $item_count; ?> results found</center></b>
    		</div>
    		<div id="btnContainer">
	...
	foreach($item_results as $item){
	    ...
	    if(@$auth_user_data[0]->id!=$item->item_user_id){
			...
			<?php } ?>
			  ...
			  <?php }else{ ?>
				<a class="right-name" href="javascript:void(0);">
				<?php } ?>
				...
				<?php 
					...
					if($online_status[$item->item_user_id]=='online'){			
						echo "Online"; 			
					}			
					else{				
    			...
    			<div class="product-content">
    			  <div class="product-parts">
    				...
    				<div class="buttons-both">
    				  <?php if(!empty($auth_user_data)){ ?>
    					<a href="javascript:followUser(<?php echo $item->item_user_id; ?>);" class="follow_user follow_<?php echo $item->item_user_id; ?>">
    						<?php
