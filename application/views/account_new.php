          ...
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#items" data-toggle="tab">Publish Items</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="#follow_users" data-toggle="tab">Followings</a></li>
				<li class="nav-item"><a class="nav-link" href="#user_order" data-toggle="tab">Purchase</a></li>
...
<div id="change_status" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header" style="padding: 15px;">
          <h4 class="modal-title" id="typeofstatus"></h4>
          <button type="button" style="padding: 7px 14px 0px 0px;" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
          <center><h5>Status</h5>
